  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary p-6">
      <motion.div
        ...
        className="w-full max-w-3xl bg-black rounded-xl overflow-hidden border-2 border-secondary shadow-lg"
      >
        {/* Header */}
        <motion.div
          initial={{ y: -50 }}
          ...
          className="bg-secondary p-4 flex items-center space-x-4 rounded-t-xl"
        >
              ...
              >
                <div
                  className={`max-w-[80%] px-4 py-3 rounded-2xl ${
                    msg.sender === "ai" ? "bg-secondary text-black" : "bg-black text-secondary border border-secondary"
                  }`}
                >
        ...
        <motion.div
          ...
          className="p-6 bg-black border-t-2 border-secondary"
        >
          <div className="relative">
            <input
              ...
              className="w-full p-4 bg-black rounded-full border-2 border-secondary focus:ring-2 focus:ring-secondary text-secondary placeholder-secondary/50 pr-24"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={sendMessage}
              className="absolute right-2 top-2 bg-secondary px-6 py-2 rounded-full font-medium text-black transition-colors hover:bg-green-500"
              disabled={isLoading}
            >
              Send
            </motion.button>
